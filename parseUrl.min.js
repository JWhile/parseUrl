...
return this._query};Url.prototype.getHost=function(){return this.parsed?this.subdomain+"."+this.domain:null};Url.prototype.getPort=function(){return this.parsed?""!==this.port?parseInt(this.port,10):e[this.protocol]||-1:-1}})();